...
public class TFIDF_anc_apc {
	...
	public void write() throws IOException {
		System.out.println("TFIDF_anc_apc writing results to: output/anc-apc.run");
		FileWriter runfileWriter = new FileWriter(new File("output/anc-apc.run"));
